# Factions, Religious Orders & Political Parties

This directory holds the individual profile files for factions, religious orders, political parties, guilds, and corporations in the setting.
...
Faction profiles are written in pure YAML (saved as `.yaml`). See `_template.yaml` for the structure.
